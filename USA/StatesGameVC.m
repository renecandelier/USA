    ...
    if (self) {
      ...
      //--------------------------------TOP CONTENT
       ...
       // headerView = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2-80, 15, 160, headerView.frame.size.height/2)];
        ...
        // Show in popup
        KLCPopupLayout layout = KLCPopupLayoutMake((KLCPopupHorizontalLayout)@"Dismiss type",
                                                   (KLCPopupVerticalLayout)@"Dismiss type");
        
        KLCPopup* popup = [KLCPopup popupWithContentView:contentView
                                                showType:(KLCPopupShowType)@"Dismiss type"
                                             dismissType:(KLCPopupDismissType)@"Dismiss type"
                                                maskType:(KLCPopupMaskType)@"Background mask"
