...
- (void)viewDidLoad
{
  ...
  childContainer.backgroundColor = [UIColor whiteColor];
    childContainer.alpha = 0.85;
...
-(void)presentWithCompletion:(void (^)(void))completion
{
  ...
  if (!self.disableBlurredBackground)
  {
    ...
    NSData *imageData = UIImageJPEGRepresentation(snapshot, 0.9);
